 ...
 *
 * The full reload-with-a-real-cookie proof for is
 * `e2e/tests/root-redirect.spec.ts` — a real browser reload is the only place
 * the boot-refresh gap actually reproduces. What this file proves is
...
describe("RootRedirect", () => {
  ...
  //: "Spinner renders; neither /login nor /dashboard navigation
  ...
  //, the other side of the boundary: an access token already
  ...
  // (unit level; the e2e spec covers the real-browser case)
  ...
  // behavior deliberately removed from this route.
