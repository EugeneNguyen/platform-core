...
_AGENT_KEY_LITERAL_PREFIX = "pcore_agent_"
...
async def _resolve_agent_actor(raw_key: str, db: AsyncSession) -> AIAgent:
    """Resolve a `pcore_agent_...` bearer credential to its `AIAgent` row.
...
async def get_current_actor(
    ...
    - a `pcore_agent_...` credential whose prefix matches zero *unrevoked*
